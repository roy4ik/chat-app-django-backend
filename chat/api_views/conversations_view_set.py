...
class ConversationViewSet(ModelViewSet):
    ...
    def list(self, request, pk=None, **kwargs) -> Response:
    ...
    def list_owned_conversations(self, request, pk=None, **kwargs) -> Response:
    ...
    def get_queryset(self) -> Union[QuerySet, List[Conversation]]:
        """
